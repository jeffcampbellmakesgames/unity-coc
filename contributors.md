# Contributing
Thanks for considering contributing to JCMG CoC! Read the guidelines below before you submit an issue or create a PR. 
...
* **releases/stable:** This branch is orphaned and contains only the package contents for JCMG.CoC. This is updated in sync with tagged releases on **master** and each commit that changes these contents should result in the version in **package.json** being changed.
...
| ----------- | -------- | ------- |
| Namespaces | PascalCase | `JCMG.CoC.Editor` |
| Classes | PascalCase | `VersionParser` |
...
## Pull requests
Pull requests should be made to the [develop branch](https://github.com/jeffcampbellmakesgames/unity-coc/tree/develop).